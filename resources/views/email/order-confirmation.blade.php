...
{{--                                                <p style="font-family:'Segoe UI', sans-serif, Arial, Helvetica, Lato;">{{ $data['data'] ['shipping']? $data['data'] ['shipping']->name:'$'. $data['data'] ['order']->shipping}}</p>--}}
                                        ...
                                        <tr>
                                            ...
                                            <td align="center">
                                                <p style="font-family:'Segoe UI', sans-serif, Arial, Helvetica, Lato;">{{ucwords( $data['data'] ['order']->payment->payment_by)}}</p>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th width="65%" align="left">
                                    ...
                                    <table align="center" border="1" style="border-color: #ddd" class="display-width-inner" cellpadding="10" cellspacing="0" width="700">
                                        ...
                                        <tr>
                                            <td width="50%" align="left">
                                                @php $billing =  $data['data'] ['order']->user->billingAddress  @endphp
                                            ...
                                            <td width="50%" align="left">
                                                @php $shipping =  $data['data'] ['order']->address  @endphp
